...
namespace Laparoscope.Utils.Authorization
{
    ...
    public static class ControllerAuthorizationExtensions
    {
        ...
        /// <returns></returns>
        public static string ControllerName(this Controller conn)
        {
        ...
        /// <returns></returns>
        public static IEnumerable<T> WhereAuthorized<T>(this Controller Controller, IEnumerable<T> Collection)
        {
        ...
        /// <returns></returns>
        public static bool IsAuthorized<T>(this Controller Controller, T Model)
        {
            var context = Controller.ControllerName();
            var roles = (Controller?.Request?.HttpContext.User)?.RoleClaims();
            if (roles != null)
        ...
        /// <param name="Collection"></param>
        /// <returns></returns>
        public static IEnumerable<Dictionary<string, object>> WhereAuthorized(this Controller Controller, IEnumerable<Dictionary<string, object>> Collection)
        {
            var context = Controller.ControllerName();
            var roles = (Controller?.Request?.HttpContext.User)?.RoleClaims()?.Distinct();
            if (roles != null)
            {
                // TODO LOGME (Sean) log null role set
            }
        ...
        /// <param name="Model"></param>
        /// <returns></returns>
        public static bool IsAuthorized(this Controller Controller, Dictionary<string, object> Model)
        {
            var context = Controller.ControllerName();
            var roles = (Controller?.Request?.HttpContext.User)?.RoleClaims();
            if (roles != null)
